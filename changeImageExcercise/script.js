...
var originalColor = blockItem.style.backgroundColor;

// CHANGE THE BLOCK CSS BACK AGAIN WHEN THE MOUSEOUT event is fired

blockItem.onmouseover = function() {
    blockItem.style.background = "green";
    blockItem.style.border = "10px solid black";
}

blockItem.onmouseout = function() {
  blockItem.style.backgroundColor = originalColor};